...
parser.add_argument("-f", "--framework", type=str, help="Lokalizacja/folder framework'u/bibliotek OpenCPLC (default: opencplc)" , default="opencplc")
parser.add_argument("-p", "--project", type=str, help="Lokalizacja/folder projektu wybranego do kompilacji (default: projects/{name})" , default="")
parser.add_argument("-b", "--build", type=str, help="Lokalizacja/katalog dla skompilowanych plików frameworka i projektu (default: build)", default="build")
...
parser.add_argument("-v", "--version", action="store_true", help="Wersję programu 'wizard' oraz inne ciekawe informacje", default=False)
