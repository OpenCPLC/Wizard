...
- `-m --memory`: Ilość pamięci FLASH w wykorzystywanej płytce. <u>Nie należy ustawiać dla oficjalnie wspieranych konstrukcji</u>. W przypadku konstrukcji niestandardowych należy wybrać `128kB` lub `512kB`, w zależności od użytego mikrokontrolera.
